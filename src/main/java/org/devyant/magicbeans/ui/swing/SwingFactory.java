...
import org.devyant.magicbeans.ui.swing.layout.gridbag.SwingGridBagMagicLayout;
...
public class SwingFactory extends AbstractUIFactory<JComponent> {
     ...
     */
    @Override
    protected MagicLayout createLayout(IsolatedBehaviourType type) {
        return new SwingGridBagMagicLayout(type);
    }
    /**
