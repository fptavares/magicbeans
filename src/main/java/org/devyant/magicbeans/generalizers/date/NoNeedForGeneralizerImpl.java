...
/**
 * NoNeedForGeneralizerImpl is a <b>cool</b> class.
 * 
 * @author Filipe Tavares
 * @version $Revision$ $Date$ ($Author$)
 * @since 12/Jun/2005 4:54:12
 */
public class NoNeedForGeneralizerImpl extends DateGeneralizer {
    /**
    ...
    protected void setTheValue(Object date, Date value) {
        ((Date) date).setTime(value.getTime());
    }
    /**
